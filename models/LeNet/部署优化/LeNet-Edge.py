...
"""
LeNet-Edge: 专为边缘设备优化的LeNet
===================================

历史背景：
----------
随着物联网和边缘计算的发展，越来越多的应用需要在资源受限的边缘设备上运行深度学习模型。
本实现针对边缘设备的特点，对LeNet进行了专门的优化，使其更适合在边缘设备上部署和运行。
...
class LeNetEdge(nn.Module):
    """
    专为边缘设备优化的LeNet实现
    """
    def __init__(self, num_classes: int = 10):
        super(LeNetEdge, self).__init__()
...
def export_to_onnx(model: nn.Module,
                  ...
                  onnx_path: str = 'lenet_edge.onnx') -> None:
    """
    导出模型到ONNX格式
    """
